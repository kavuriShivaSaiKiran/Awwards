...
const BentoTilt = ({children, className})=>{
    ...
    return (
        <div className={className} ref={itemRef} onMouseMove={(e) => handleMouseMove(e)} 
        ...
        <div className=" relative size-full  " >
            ...
            <div className=" relative z-10 flex size-full flex-col justify-between p-5 text-blue-50 " >
                <div>
                    ...
                    {description &&
                        <p className=" font-circular-web text-xs md:text-base  mt-3 max-w-64  " >{description}</p>
                    }
                </div>
            </div>
        </div>
      ...
      <div className=" container mx-auto px-3 md:px-10 " >
        <div className=" px-5 py-32 " >
            ...
            <p className=" max-w-md font-circular-web text-lg text-blue-50  opacity-50 " >
                Immerse yourself in a rich and ever-expading universe where a vibrant
        ...
        <div className=" grid h-[135vh] grid-cols-2 grid-rows-3 gap-7 " >
            <BentoTilt className=" bento-tilt_1 row-span-1 md:col-span-1 md:row-span-2 " >
                <BentoCard 
                    ...
                    title={<>Zig<b>m</b>a</>}
                    description={"Your gateway to the metaverse, where you can"}
                />
            </BentoTilt>
            ...
            <BentoTilt className=" bento-tilt_1 me-14 md:col-span-1 md:me-0" >
                <BentoCard
                    ...
                    title={<>az<b>u</b>le</>}
                    description={
                        "A cross-world AI Agent - elivating your gameplay to be more fun and productive."
                    }
                />
            </BentoTilt>
            ...
            <BentoTilt className=" bento-tilt_2 " >
                <div className="flex size-full flex-col justify-between bg-violet-300 p-5 " >
                    <h1 className=" max-w-64 bento-title special-font " >M<b>o</b>re co<b>m</b>ing So<b>o</b>n!</h1>
