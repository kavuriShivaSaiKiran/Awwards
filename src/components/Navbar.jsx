...
const Navbar = () => {
  ...
  return (
    <div ref={navContainerRef} className="fixed top-4 inset-x-0 z-50 h-16 border-none transition-all duration-700 sm:inset-x-6">
        ...
        <nav className=" flex size-full items-center justify-between p-4  " >
          ...
          <div className=" flex h-full items-center " >
            ...
            <button 
              ...
              className=" ml-10 flex items-centers space-x-0.5 " >
